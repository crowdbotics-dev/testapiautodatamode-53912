...
## Project Structure
    ...
    ├── testapiautodatamode_53912  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamode_53912`
...
2. Clone this repo and `cd testapiautodatamode_53912`
